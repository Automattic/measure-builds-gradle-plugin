# measure-builds Gradle Plugin [![Pre Merge Checks](https://github.com/Automattic/measure-builds-gradle-plugin/actions/workflows/pre-merge.yaml/badge.svg)](https://github.com/Automattic/measure-builds-gradle-plugin/actions/workflows/pre-merge.yaml)
